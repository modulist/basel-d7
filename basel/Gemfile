...
group :development do
  ...
  gem 'singularitygs'           # Lightweight, incredibly configurable grid framework.
  gem 'toolkit', '~>2.5.2'      # Compass utility from the fabulous Snugug.
  gem 'breakpoint'              # Manages CSS media queries.
  gem 'oily_png'                # Faster Compass sprite generation.
  gem 'css_parser'              # Helps `compass stats` output statistics.
  gem "autoprefixer-rails"      # Adds vendor prefixes automatically to plain css
